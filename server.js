...
https.createServer(
    {
        key: fs.readFileSync('/etc/letsencrypt/live/wyntergailey.cit270.com/privkey.pem'),
        cert: fs.readFileSync('/etc/letsencrypt/live/wyntergailey.cit270.com/cert.pem'),
        ca: fs.readFileSync('/etc/letsencrypt/live/wyntergailey.cit270.com/fullchain.pem')
